...
export function SdkPage() {
  ...
  return <main className="sdk-page">
    <header className="sdk-header"><a className="wordmark" href="/"><span>✣</span> INVERTASE</a><nav><a href="#development">Services⌄</a><a href="#development">Open source</a><a href="#maintenance">Products⌄</a><a href="#faq">Blog</a><a href="#footer">Company⌄</a></nav><div className="header-actions"><span>◉ 33.9k</span><a className="header-cta" href="#footer">Get in touch</a></div></header>
